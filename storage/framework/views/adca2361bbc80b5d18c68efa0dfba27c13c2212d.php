                            ...
                            <div class="profile-head">
                                <div class="photo-content">
                                    <div class="cover-photo">
										<img src="<?php echo e(asset('assets/icons/pr.jpg')); ?>" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="profile-info">
									<div class="profile-photo">
										<img src="<?php echo e(asset('assets/icons/ava.png')); ?>" width="200" class="img-fluid rounded-circle" alt="">
									</div>
									<div class="profile-details">
										<div class="profile-name px-3 pt-2">
											<h4 class="text-primary mb-0"><?php echo e($client['name']); ?></h4>
											<p>Service and Order</p>
										</div>
										<div class="profile-email px-2 pt-2">
											<h4 class="text-muted mb-0"><?php echo e($client['email']); ?></h4>
											<p>Email</p>
										</div>
                                        <div class="ml-auto">
                                                    ...
                                                    <div class="modal fade" id="editProfile">
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <form action="<?php echo e(route ('post.edit', $id)); ?>" method="post">
                                                                    <?php echo csrf_field(); ?>
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="email" name="email" id="email" class="form-control" value="<?php echo e($client['email']); ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="nowa" class="mb-1 text-grey">No. Wa</label>
                                                                        <input type="nowa" name="nowa" id="nowa" class="form-control" value="<?php echo e($client['Nowa']); ?>">
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label for="alamat" class="mb-1 text-grey">Alamat</label>
                                                                        <input type="alamat" name="alamat" id="alamat" class="form-control" value="<?php echo e($client['alamat']); ?>">
                                                                    </div>
                                                                </div>
                                            ...
                                            <div id="about-me" class="tab-pane fade active show">
                                                <div class="profile-personal-info">
                                                    <div class="row mb-2 mt-3">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span><?php echo e($client['name']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span><?php echo e($client['email']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span><?php echo e($client['Nowa']); ?></span>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-2">
                                                        <div class="col-sm-3 col-5">
                                                        ...
                                                        <div class="col-sm-9 col-7"><span><?php echo e($client['alamat']); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('\layout\viewnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sentracom_projek\resources\views/users/profile.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('content'); ?>
                            ...
                            <div class="card-body">
                                <div class="profile-news">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?php echo e(asset('assets/images/profile/5.jpg')); ?>" alt="image" class="mr-3 rounded" width="75">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?php echo e(asset('assets/images/profile/6.jpg')); ?>" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="<?php echo e(asset('assets/images/profile/7.jpg')); ?>" alt="image" class="mr-3 rounded" width="75">
                                        <div class="media-body">
                                            <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of textile samples</a></h5>
                                            <p class="mb-0">I shared this on my fb wall a few months back, and I thought.</p>
                                        </div>
        ...
        ***********************************-->
<?php $__env->stopSection(); ?>
<?php echo $__env->make('\layout\viewnavbar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\sentracom_projek\resources\views/dashboard.blade.php ENDPATH**/ ?>